...
using DAL;
using FoodCourt.WebApp.ViewModels;
using AutoMapper;
using DAL.Models;
using Microsoft.Extensions.Logging;
using FoodCourt.WebApp.Helpers;
using Microsoft.Extensions.Options;

namespace FoodCourt.WebApp.Controllers
{
    ...
    public class CustomerController : Controller
    {
        ...
        public async Task<string> Email()
        {
            ...
            (bool success, string errorMsg) response = await _emailer.SendEmailAsync(recepientName, recepientEmail, "Test Email from FoodCourt.WebApp", message);
